	...
	<ul class="nav">
		...
		<li class="nav-item" >
			...
			<div class="collapse" id="user_management">
				<ul class="nav flex-column sub-menu">
					<li class="nav-item">
						<a class="nav-link" href="<?= base_url();?>superpanel/viewer">Customer</a>
					</li>
				</ul>
			</div>
		</li>
		...
		<li class="nav-item" >
			...
			<div class="collapse" id="product_management">
				<ul class="nav flex-column sub-menu">
					<li class="nav-item">
						<a class="nav-link" href="<?= base_url();?>superpanel/category">Category</a>
					</li>
				</ul>
			</div>
		</li>
		<li class="nav-item" >
			...
			<div class="collapse" id="things">
				<ul class="nav flex-column sub-menu">
					<li class="nav-item">
						<a class="nav-link" href="<?= base_url();?>superpanel/product">Product</a>
					</li>
				</ul>
			</div>
		</li>
